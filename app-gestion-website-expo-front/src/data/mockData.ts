...
export const menuItems: MenuItem[] = [
  { id: 'dashboard', label: 'Tableau de bord', icon: 'home', screen: 'Dashboard', roles: ['Super Administrateur', 'Administrateur', 'Président', 'Directeur de Formation', 'Trésorier', 'Encadrant', 'Candidat'] },
